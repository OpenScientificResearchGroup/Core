...
#include "Core/Data/virProperty.hpp"
...
namespace core
{
	...
	class CORE_API PropertyContainerBase : public ObjectBase
	{
	public:
        ...
        const std::unordered_map<std::string, std::unique_ptr<PropertySetBase>>& getPropertySets() const;
